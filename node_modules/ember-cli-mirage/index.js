...
module.exports = {
  ...
  shouldIncludeChildAddon(childAddon) {
    console.log(this);
    let parentOptions = (this.parent && this.parent.app && this.parent.app.options && this.parent.app.options['ember-cli-mirage']) || {};
    console.log("parentOptions:");
    console.log(parentOptions);
    if(childAddon.name === 'ember-lodash') {
      return false; // !this.addonBuildConfig.excludeLodash;
    }
